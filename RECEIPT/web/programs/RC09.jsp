...
<!--                <div id="GridBankMappingnew" ></div>   -->
                    ...
                    <div class="panel panel-default container" id="reportfield" style="display: none">
                        ...
                        <div class="container panel-body col-xs-12 col-sm-12 col-md-12 col-lg-12 ">
                            ...
                            <div class="row " id="row_transfer" hidden="true">
                                ...
                                <div class="col-xs-8 col-sm-6 col-md-6 col-lg-4">
                                    <label style="width: 100%">Bank Transfer :
                                        <select class="form-control form-control-user" name="vBKTF" id="vBKTF" readonly="true" >
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-4 col-sm-3 col-md-3 col-lg-2">
                                    <label>OverPay :
                                        <input type="text" class="form-control text-center"  id="vBM_OVPAY" name="vBM_OVPAY" min="0" value="0.00" readonly="true" > 
                                    </label>
                                </div>  
                                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                                    <label>CN DN :
                                        <textarea id="vBM_CNDN" name="vBM_CNDN" rows="2" cols="100" class="form-control" readonly="true"></textarea>
                                    </label>
                                </div>
                            </div>
                            <br>
    ...
    <script type="text/javascript">
        ...
        function Call_GridBankMapping() {
            $("#GridBankMapping").show();
            $("#GridBankMapping").jsGrid({
                width: "100%",
                height: "auto",
                filtering: true,
                inserting: false,
                    ...
                    loadData: function (filter) {
                        ...
                        $.ajax({
                            ...
                            response = $.grep(response, function (item) {
                                return (!filter.BM_RCNO || (item.BM_RCNO.indexOf(filter.BM_RCNO) > -1))
                ...
                fields: [
                    ...
                    {title: "ID", width: 30, name: "ID", type: "text", align: "center", editing: false},
            ...
            $("#GridBankMappingnew").jsGrid({
                ...
                fields: [
                    ...
                    {title: "ID2", width: 30, name: "H_RNNO", type: "text", align: "center", editing: false},
        ...
        var showDetailsDialog1 = function (dialogType, client) {
            ...
            SearchReceipt(client.BM_RCNO);
            updateRequester(client.BM_RCNO);
            console.log(client);
        };
        function SearchReceipt(RCNO) {
            ...
            $.ajax({
                ...
                dataType: 'json',
                data: {
                    page: "SearchReceipt_BankMapping",
                    CONO: cono,
                    DIVI: divi,
                    RCNO: RCNO,
                    LOCATION: locations
