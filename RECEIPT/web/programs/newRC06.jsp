...
<html>
    ...
    <body >
        <div class="container">
                        ...
                        <div class="container panel-body col-xs-12 col-sm-12 col-md-12 col-lg-12 ">
                            <div class="row ">
                                ...
                                <div class="col-xs-4 col-sm-3 col-md-3 col-lg-2">
                                    ...
                                    <button class="btn btn-success" id="vScusno" name="vScusno" type="button" >Search Customer No.</button>
                            ...
                            <div class="row">
                                <div class="form-group">
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-4">
                                            <input  type="radio" name="optionsRadio" id="cash" value="CASH_DEPOSIT" onclick="radiobtn()">&nbsp;<label class="control-label">CASH DEPOSIT</label>
                                        </div>
                                        <div class="col-md-4">
                                            <input  type="radio" name="optionsRadio" id="transfer" value="TRANSFER_DEPOSIT" onclick="radiobtn()">&nbsp;<label class="control-label">TRANSFER DEPOSIT</label>
                                        </div>
                                        <div class="col-md-4">
                                            <input  type="radio" name="optionsRadio" id="check" value="CHECK_DEPOSIT" onclick="radiobtn()">&nbsp;<label class="control-label">CHECK DEPOSIT</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <label style="width: 100%">Select Printer :
                                            <select class="form-control form-control-user" name="vPrinter" id="vPrinter">
                                                <!--                                                <option value="RECEIPT PRINTER">PRINTER 1</option>
                                                                                                ...
                                                                                                <option value="RECEIPT PRINTER3">PRINTER 3 : DC</option>-->
                                            </select>
                                        </label>
                                    </div>
                                    <br>
            ...
            <!--<button type="button" id="GETPDF" name="GETPDF">few</button>-->
        </div>
  ...
  function  Call_twinGrid() {
        ...
        $("#vAddRec").click(function (e) {
            ...
            if ($("#vRCNO").val() !== "") {
                ...
                alert("Please check receipt number !!");
            }
            ...
            if (value === "DRIVER") {
                $.ajax({
                    ...
                    $.each(response, function (i, obj) {
                        document.getElementById("vReceiver").value = obj.NCarno;
                    });
                });
            } else if (value === "SALE") {
                $.ajax({
...
//            Call_GridReceipt();
        ...
        function radiobtn() {
            ...
            } else if (radioValue === 'TRANSFER_DEPOSIT') {
                $("#row_transfer").show();
        ...
        function List_Printer() {
            ...
            if (locations === "LS" && (username === "SANTIM_PUP" || username === "TAWA_HOA" || username === "NITTAY_KOM" || username === "JILASA_SAM")) {
        ...
        $("#vCreate").click(function (e) {
            ...
            if (radioValue === 'TRANSFER_DEPOSIT') {
                HC_PYDT = $("#vDTTF").val();
                var input = $("#vBKTF").val();
...
//                    return;
            ...
            } else if (radioValue === 'CHECK_DEPOSIT') {
                HC_PYDT = $("#vDTPM").val();
                HC_BANK = $("#vBKCH").val();
                HC_CHKNO = $("#vCHKNO").val();
                if ($("#vDTPM").val() === "") {
...
//        });
        ...
        function Cal_LineAmount() {
            ...
            $.ajax({
                ...
                $.each(response, function (i, obj) {
                    ...
                    balance = parseFloat(balance) - (obj.LineAmout * -1);
        ...
        $('#vSearch').click(function (e) {
            ...
            $.ajax({
                ...
                //////////////////////////////////////////
                SearchHeaderdeposit(document.getElementById("vRCNO").value, FNNO);
...
//            Call_Receipt();
            ...
            /*
             ...
             if (obj.HC_TYPE === "CASH_DEPOSIT") {
             document.getElementById("cash").checked = true;
             } else if (obj.HC_TYPE === "TRANSFER_DEPOSIT") {
             ...
             } else if (obj.HC_TYPE === "CHECK_DEPOSIT") {
...
//        
        ...
        function SearchHeaderdeposit(RCNO, FNNO) {
...
//                Call_Receipt();
//
////                SearchHeader(document.getElementById("vFNCODE").value);
...
//        });
        ...
        $("#vComplete").click(function (e) {
            ...
            data.append("REPRINT", "DEPOSIT");
            var vRCNO = "" + $("#vRCNO").val();
            var radioValue = $("input[name='optionsRadio']:checked").val();
            if (radioValue !== "TRANSFER_DEPOSIT" || $("#vREAMT").val().replace(/,/g, '') !== "0.00") {
                AddUpdateReceiver();
            }
...
//                                    location.href = "http://192.200.9.106:8080/RECEIPT/Report?vRCNO=" + vRCNO + "&vReport=RP01";
