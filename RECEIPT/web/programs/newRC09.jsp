...
//
//                                return (!filter.BM_ID || (item.ID.indexOf(filter.BM_ID) > -1))
...
//                fields: [
//
//                    {title: "ID2", width: 30, name: "ID", type: "text", align: "center", editing: false},
//
...
//todo print click
            ...
            var url = " Report?vRCNO=" + vRCNO + "&last=FASLE&checkbl="+CHECKBL+"&vReport=RP013";
