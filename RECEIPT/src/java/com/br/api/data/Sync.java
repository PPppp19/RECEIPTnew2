...
//                    out.print(SelectDB2.Grid_Series(request.getParameter("cono"), request.getParameter("divi"), request.getParameter("username"), request.getParameter("location")));
                ...
                try {
                    out.print(SelectDB2.Grid_ARS200_cus(request.getParameter("cono"), request.getParameter("divi"), request.getParameter("payer"), request.getParameter("rcno")));
                    out.flush();
                } catch (JSONException ex) {
                    Logger.getLogger(Sync.class.getName()).log(Level.SEVERE, null, ex);
                }
...
//                    }
                ...
                try {
                    out.print(SelectDB2.Getfncode(request.getParameter("cono"), request.getParameter("divi"), request.getParameter("pyno")));
                    out.flush();
